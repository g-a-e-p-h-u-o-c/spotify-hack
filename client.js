...
// loudnessChart.data.datasets[0].data = json.segments.map(({ start: x, loudness_start: y }) => ({ x, y }))
// keyChart.data.datasets[0].data = json.sections.map(({ start: x, key: y }) => ({ x, y }));
// tempoChart.data.datasets[0].data = json.sections.map(({ start: x, tempo: y }) => ({ x, y }));
